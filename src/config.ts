...
const defaultConfig: Config = {
  ...
  deniedCommandReplies: {
    ...
    cooldowns: {
      user: 'You can use this command again <t:{timestamp}:R> (at <t:{timestamp}:T>).',
      guild: 'This command is on cooldown for this server. Try again <t:{timestamp}:R> (at <t:{timestamp}:T>).',
      global: 'This command is on global cooldown. Try again <t:{timestamp}:R> (at <t:{timestamp}:T>).',
    },
  },
